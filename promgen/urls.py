...
urlpatterns = [
    ...
    path(
        "service/<int:pk>/delete", views.ServiceDelete.as_view(), name="service-delete"
    ),
    path("service/<int:pk>/new", views.ProjectRegister.as_view(), name="project-new"),
    path(
        "service/<int:pk>/update", views.ServiceUpdate.as_view(), name="service-update"
    ),
    path(
        "service/<int:pk>/notifier",
        views.ServiceNotifierRegister.as_view(),
    ...
    path(
        "project/<int:pk>/update", views.ProjectUpdate.as_view(), name="project-update"
    ),
    ...
    path(
        "project/<int:pk>/exporter",
        views.ExporterRegister.as_view(),
        name="project-exporter",
    ),
    path(
        "project/<int:pk>/notifier",
        views.ProjectNotifierRegister.as_view(),
        name="project-notifier",
    ),
    path(
        "exporter/<int:pk>/delete",
        views.ExporterDelete.as_view(),
        name="exporter-delete",
    ),
    path(
        "exporter/<int:pk>/toggle",
        views.ExporterToggle.as_view(),
        name="exporter-toggle",
    ),
    ...
    path(
        "farm/<int:pk>/scrape", views.ExporterScrape.as_view(), name="exporter-scrape"
    ),
    ...
    path(
        "notifier/<int:pk>/delete",
        views.NotifierDelete.as_view(),
        name="notifier-delete",
    ),
    ...
    path(
        "<content_type>/<object_id>/rule",
        views.AlertRuleRegister.as_view(),
        name="rule-new",
    ),
    ...
    # Promgen API
    path(
        "api/v1/targets", csrf_exempt(views.ApiConfig.as_view()), name="config-targets"
    ),
    ...
    path(
        ...
        proxy.ProxyLabelValues.as_view(),
        name="proxy-values",
    ),
    ...
    path(
        "proxy/v1/alerts", csrf_exempt(proxy.ProxyAlerts.as_view()), name="proxy-alerts"
    ),
    path(
        "proxy/v1/silences",
        csrf_exempt(proxy.ProxySilences.as_view()),
        name="proxy-silence",
    ),
    path(
        "proxy/v1/silences/<silence_id>",
        csrf_exempt(proxy.ProxyDeleteSilence.as_view()),
        name="proxy-silence-delete",
    ),
