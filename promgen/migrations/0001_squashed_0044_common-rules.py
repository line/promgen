    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "farm",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="promgen.Farm"
                    ),
                ),
            ],
            options={"ordering": ["name"],},
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=128,
                        validators=[promgen.validators.duration],
                    ),
                ),
                ("enabled", models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rule",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="promgen.Rule"
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="promgen.Shard"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="service",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="promgen.Service"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="farm", unique_together=set([("name", "source")]),
        ),
        migrations.AddField(
            model_name="exporter",
            name="project",
        ...
        migrations.AlterUniqueTogether(
            name="prometheus", unique_together=set([("host", "port")]),
        ),
        migrations.AlterUniqueTogether(
            name="host", unique_together=set([("name", "farm")]),
        ),
        migrations.AlterUniqueTogether(
            name="exporter", unique_together=set([("job", "port", "project")]),
        ),
    ]
