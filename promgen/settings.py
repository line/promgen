...
PROMGEN_CONFIG = os.environ.get(
    "PROMGEN_CONFIG", os.path.join(PROMGEN_CONFIG_DIR, "promgen.yml")
)
...
STATIC_URL = "/static/"
STATIC_ROOT = os.environ.get("STATIC_ROOT", os.path.expanduser("~/.cache/promgen"))
...
if "SENTRY_DSN" in os.environ:
    ...
    LOGGING = {
        ...
        "loggers": {
            "": {"handlers": ["sentry"], "level": "ERROR", "propagate": True,},
        },
    }
