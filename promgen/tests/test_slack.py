...
class SlackTest(PromgenTest):
    ...
    def setUp(self, mock_signal):
        ...
        self.sender = models.Sender.objects.create(
            obj=self.project, sender=NotificationSlack.__module__, value=self.TestHook1,
        )
    ...
    def test_slack(self, mock_post):
        ...
        self.client.post(
            reverse("alert"), data=json.dumps(SAMPLE), content_type="application/json"
        )
        ...
        mock_post.assert_has_calls(
            [
                ...
                mock.call(self.TestHook2, json={"text": _RESOLVED},),
            ],
            any_order=True,
        )
