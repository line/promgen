                ...
                if objs.exists():
                    ...
                    if count <= 20:
                        ...
                        messages.append(
                            {
                                "class": "alert alert-warning",
                                "message": f"You do not have permission to expire the silence that "
                                f"matches the following {label}: {names}",
                            }
                        )
                    else:
                        messages.append(
